...
public class IndexController {
	...
	@Autowired
	private HelpTextBuilder helptextbuilder;
	...
	//*********************************************************
		@RequestMapping (value="/helptext", method = RequestMethod.GET)
		public String HelpT(Model model){
			HelpText ht = new HelpText();
			model.addAttribute("helptext", ht);
			return "HelpText";
		}
		
		@RequestMapping(value = "/helptext", method = RequestMethod.POST, params ="SQLScript")
		public String doSQL(@ModelAttribute("HelpText") HelpText ht,ModelMap model) {
			String a = helptextbuilder.sql(ht.getHELPPROG(), ht.getHELPITEM(), ht.getHELPLINE(), ht.getSPLIT()).toString();
			//System.out.println(a);
			model.addAttribute("resultsql", a);
			return "Result";
		}
		@RequestMapping(value = "/helptext", method = RequestMethod.POST, params ="OracleScript")
		public String doOracle(@ModelAttribute("HelpText") HelpText ht,ModelMap model) {
			String b = helptextbuilder.oracle(ht.getHELPPROG(), ht.getHELPITEM(), ht.getHELPLINE(), ht.getSPLIT()).toString();
			model.addAttribute("resultoracle", b);
			return "Result";
		}
